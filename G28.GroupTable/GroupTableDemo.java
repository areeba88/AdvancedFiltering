...
//UIManager.getDefaults().put("TableHeader.autoFilterTableHeaderUIDelegate", CustomAutoFilterTableHeaderUIDelegate.class.getName());
                UIManager.getDefaults().put(/*"TableHeader.autoFilterTableHeaderUIDelegate"*/"TableHeader.groupTableHeaderUIDelegate", CustomAutoFilterTableHeaderUIDelegate.class.getName());
