...
public class JMenuAdvancedFilteringOnCustomData extends AbstractDemo {
	...
	JCheckBox filterAsYouType =  new JCheckBox("Filter As You Type");
	...
	JMenuAdvancedFilteringOnCustomData oJMenuAdvancedFilteringOnCustomData;
	public JMenuAdvancedFilteringOnCustomData(JMenuAdvancedFilteringOnCustomData oJMenuAdvancedFilteringOnCustomData){

		this.oJMenuAdvancedFilteringOnCustomData = oJMenuAdvancedFilteringOnCustomData;	
	}


	public JMenuAdvancedFilteringOnCustomData() {
	...
	public Component getOptionsPanel() {
		...
		filterAsYouType.addItemListener(new ItemListener() {
		...
		checkBoxPanel.add(filterAsYouType);
...
//		_filterManager.registerDefaultFilterFactories();
		...
		_table.setExpandedIcon(IconsFactory.getImageIcon(JMenuAdvancedFilteringOnCustomData.class, "icons/outlook_collapse.png"));
		_table.setCollapsedIcon(IconsFactory.getImageIcon(JMenuAdvancedFilteringOnCustomData.class, "icons/outlook_expand.png"));
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				UIManager.getDefaults().put("TableHeader.groupTableHeaderUIDelegate", JMenuCustomAutoFilterTableHeaderUIDelegate.class.getName());
				...
				panel.add(new JMenuAdvancedFilteringOnCustomData().getDemoPanel());
				...
				btn.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						int rowCount=JMenuAdvancedFilteringOnCustomData._groupTableModel.getRowCount();

						for (int i = 0; i < rowCount; i++) {

							JMenuAdvancedFilteringOnCustomData._groupTableModel.setValueAt(JMenuAdvancedFilteringOnCustomData.parseDate(dateData[i]), i, 8);
						}
	...
	class DateFilterListener implements ActionListener
	{
		...
		private void dateTypeFilterApplied(Filter dateFilter){
			...
			JMenuCustomAutoFilterTableHeaderUIDelegate.popupPanel.getTopLevelAncestor().setVisible(false);
