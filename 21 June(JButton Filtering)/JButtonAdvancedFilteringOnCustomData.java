...
public class JButtonAdvancedFilteringOnCustomData extends AbstractDemo {
	public static GroupTable _table;
	...
	JButtonAdvancedFilteringOnCustomData oJButtonAdvancedFilteringOnCustomData;
	public JButtonAdvancedFilteringOnCustomData(JButtonAdvancedFilteringOnCustomData oJButtonAdvancedFilteringOnCustomData){

		this.oJButtonAdvancedFilteringOnCustomData = oJButtonAdvancedFilteringOnCustomData;	
	}


	public JButtonAdvancedFilteringOnCustomData() {
		...
		searchAsUType.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if(e.getStateChange() == ItemEvent.SELECTED ){
					...
					header.setAllowMultipleValues(false);	
	...
	public Component getDemoPanel() {
		...
		_table.setExpandedIcon(IconsFactory.getImageIcon(JButtonAdvancedFilteringOnCustomData.class, "icons/outlook_collapse.png"));
		_table.setCollapsedIcon(IconsFactory.getImageIcon(JButtonAdvancedFilteringOnCustomData.class, "icons/outlook_expand.png"));
...
static	JScrollPane parentPane = null;
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				UIManager.getDefaults().put("TableHeader.groupTableHeaderUIDelegate", JButtonCustomAutoFilterTableHeaderUIDelegate.class.getName());
				...
				panel.add(new JButtonAdvancedFilteringOnCustomData().getDemoPanel());
				...
				btn.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						int rowCount=JButtonAdvancedFilteringOnCustomData._groupTableModel.getRowCount();

						for (int i = 0; i < rowCount; i++) {

							JButtonAdvancedFilteringOnCustomData._groupTableModel.setValueAt(JButtonAdvancedFilteringOnCustomData.parseDate(dateData[i]), i, 8);
						}
	...
	public static boolean isDateFilterApplied = false;
	...
	class DateFilterListener implements ActionListener
	{
		...
		private void dateTypeFilterApplied(Filter dateFilter){
			...
			JButtonAdvancedFilteringOnCustomData.isDateFilterApplied = true;
